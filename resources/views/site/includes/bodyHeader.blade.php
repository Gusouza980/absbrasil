<div id="backdrop" style="background:#e5e5e5">
    <div class="logo"><img src="{{ asset('site/img/logoABS.png') }}" width="115" height="115"
            alt="Logomarca ABS - Brasil"></div>
</div>
<header class="header {{ $classe }}"
    @if ($classe == 'brasil cursos' && isset($curso)) style="background-image: url({{ asset($curso->banner) }})" @endif>
    <section class="logos" style="max-width: 1250px!important;">
        <a class="ancora" href="/" title="Home"><img src="{{ asset('site/img/logoABS.png') }}" width="115"
                height="115" alt="Logomarca ABS - Brasil"></a>
        <a class="asi" target="_blank" rel="noopener" title="Navegar para ASI" href="https://www.asi.info/"><img
                src="{{ asset('site/img/logoASI.png') }}" width="90" height="90" alt="Logomarca ASI"></a>
        <!--<h1>'.PAGINA_TITULO.'</h1>-->
        ...
        <nav class="sobe">
            <div class="menuLateral">
                ...
                <a href="/minha-conta" title="Usuário"><img width="23" height="23"
                        src="{{ asset('site/img/ico_user.svg') }}" alt="Usuário"></a>
                <a href="{{ route('site.contato') }}" title="Ajuda"><img width="23" height="23"
                        src="{{ asset('site/img/ico_ajuda.svg') }}" alt="Ajuda"></a>
                <a href="{{ $configuracoes->youtube }}" title="Youtube" target="_blank" rel="nofollow noopener"><img
                        width="27" height="27" src="{{ asset('site/img/ico_youtube.svg') }}" alt="Youtube"></a>
                <a href="{{ $configuracoes->instagram }}" title="Instagram" target="_blank"
                    rel="nofollow noopener"><img width="27" height="27"
                        src="{{ asset('site/img/ico_insta.svg') }}" alt="Instagram"></a>
                <a href="{{ $configuracoes->facebook }}" title="Facebook" target="_blank" rel="nofollow noopener"><img
                        width="27" height="27" src="{{ asset('site/img/ico_face.svg') }}" alt="Facebook"></a>
                <a class="whatsapp" href="https://api.whatsapp.com/send?phone=55{{ $configuracoes->whatsapp }}"
                    title="WhatsApp" target="_blank" rel="nofollow noopener"><img width="27" height="27"
        ...
        <nav>
            <div class="menuHeader">
                <a href="{{ route('site.cursos') }}"
                    @if (url()->current() == route('site.cursos')) class="ativo" @endif>Exames</a>
